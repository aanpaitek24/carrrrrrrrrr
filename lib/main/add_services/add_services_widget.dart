...
import 'add_services_model.dart';
export 'add_services_model.dart';

class AddServicesWidget extends StatefulWidget {
  const AddServicesWidget({super.key});

  @override
  State<AddServicesWidget> createState() => _AddServicesWidgetState();
}

class _AddServicesWidgetState extends State<AddServicesWidget> {
  late AddServicesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddServicesModel());
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        FlutterFlowChoiceChips(
                                          options: const [
                                            ChipData('Full-Service'),
                                            ChipData('Exterior-Only'),
                                            ChipData('Interior-Only'),
                                            ChipData('Express Wash'),
                                            ChipData('Detailing'),
                                            ChipData('Hand Wash'),
                                            ChipData('Automated Wash'),
                                            ChipData('Wrap')
                                          ],
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await servicesRecordReference
                          ...
                          type: _model.productNameTextController.text,
                          ...
                          contact: _model.contactNumTextController.text,
                          categgory: _model.choiceChipsValue,
                        ...
                        _model.servicesAddd =
                            ServicesRecord.getDocumentFromData(
                                createServicesRecordData(
                                  ...
                                  carwashName:
                                      _model.carwashNameTextController.text,
                                  oldPrice: int.tryParse(
