...
class _CreateServicesWidgetState extends State<CreateServicesWidget> {
  ...
  void initState() {
    ...
    _model.carwashNameFocusNode!.addListener(() => setState(() {}));
    _model.serviceNameTextController ??= TextEditingController();
    _model.serviceNameFocusNode ??= FocusNode();
    _model.serviceNameFocusNode!.addListener(() => setState(() {}));
    _model.locationTextController ??= TextEditingController();
    _model.locationFocusNode ??= FocusNode();
    _model.locationFocusNode!.addListener(() => setState(() {}));
    _model.phoneNumberTextController ??= TextEditingController();
    _model.phoneNumberFocusNode ??= FocusNode();
    _model.phoneNumberFocusNode!.addListener(() => setState(() {}));
    _model.oldPriceTextController ??= TextEditingController();
    _model.oldPriceFocusNode ??= FocusNode();
    _model.oldPriceFocusNode!.addListener(() => setState(() {}));
    _model.tuddzPriceTextController ??= TextEditingController();
    _model.tuddzPriceFocusNode ??= FocusNode();
    _model.tuddzPriceFocusNode!.addListener(() => setState(() {}));
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                        ...
                                        child: Container(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              ...
                                              _model.createdimage = ServicesRecord
                                                  .getDocumentFromData(
                                    ...
                                    TextFormField(
                                      controller:
                                          _model.carwashNameTextController,
                                      focusNode: _model.carwashNameFocusNode,
                                      autofocus: true,
                                      textCapitalization:
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.carwashNameFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                      ...
                                      validator: _model
                                          .carwashNameTextControllerValidator
                                          .asValidator(context),
                                    ),
                                    TextFormField(
                                      controller:
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.serviceNameFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                    ...
                                    TextFormField(
                                      controller: _model.oldPriceTextController,
                                      focusNode: _model.oldPriceFocusNode,
                                      autofocus: true,
                                      textCapitalization:
                                          TextCapitalization.words,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.oldPriceFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .oldPriceTextControllerValidator
                                          .asValidator(context),
                                    ),
                                    TextFormField(
                                      controller:
                                          _model.tuddzPriceTextController,
                                      focusNode: _model.tuddzPriceFocusNode,
                                      autofocus: true,
                                      textCapitalization:
                                          TextCapitalization.words,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Tuddz Price',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                        ...
                                        filled: true,
                                        fillColor: (_model.tuddzPriceFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .tuddzPriceTextControllerValidator
                                          .asValidator(context),
                                    ),
                                    Text(
                                      'Category',
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            'Please describe your service offer..',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await currentUserDocument!.services!
                            .update(createServicesRecordData(
                          type: _model.serviceNameTextController.text,
                          description: _model.descriptionTextController.text,
                          carwashName: _model.carwashNameTextController.text,
                          location: _model.locationTextController.text,
                          oldPrice:
                              int.tryParse(_model.oldPriceTextController.text),
                          nowPrice: int.tryParse(
                              _model.tuddzPriceTextController.text),
                          status: true,
                          categgory: _model.dropDownValue,
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Successfully created \"${_model.serviceNameTextController.text}\"',
                              style: TextStyle(
                                color: FlutterFlowTheme.of(context).primaryText,
                              ),
                            ),
